...
# data models
data_1 <- sim_model_ex1(n = 50, p = 30, i_sim = 1, seed = 1221)
data_2 <- sim_model_ex1(n = 50, p = 30, i_sim = 2, seed = 1222)
data_3 <- sim_model_ex1(n = 50, p = 30, i_sim = 3, seed = 1223)
data_4 <- sim_model_ex1(n = 50, p = 30, i_sim = 4, seed = 1224)
data_5 <- sim_model_ex1(n = 50, p = 30, i_sim = 5, seed = 1225)
data_6 <- sim_model_ex1(n = 50, p = 30, i_sim = 6, seed = 1226)
data_7 <- sim_model_ex1(n = 50, p = 30, i_sim = 7, seed = 1227)
data_8 <- sim_model_ex1(n = 50, p = 30, i_sim = 8, seed = 1228)

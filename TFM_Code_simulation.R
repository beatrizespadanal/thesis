...
# data models ex1
set.seed(1234)
data_1 <- sim_model_ex1(n = 50, p = 30, i_sim = 1)
data_2 <- sim_model_ex1(n = 50, p = 30, i_sim = 2)
data_3 <- sim_model_ex1(n = 50, p = 30, i_sim = 3)
data_4 <- sim_model_ex1(n = 50, p = 30, i_sim = 4)
data_5 <- sim_model_ex1(n = 50, p = 30, i_sim = 5)
data_6 <- sim_model_ex1(n = 50, p = 30, i_sim = 6)
data_7 <- sim_model_ex1(n = 50, p = 30, i_sim = 7)
data_8 <- sim_model_ex1(n = 50, p = 30, i_sim = 8)
